...
<html>
    ...
    <body>
      ...
      Mobile no :<input type="text" name="t4" value=<?php echo $x->getMobileno();?>><br>
       DOS :<input type="text" name="t5" value=<?php echo $x->getDos();?>><br>
      ...
      $query="Update User set Name='".$b."',Address='".$c."',Mobileno='".$d."',DOS='".$e."',upass='".$g."' where Code=".$a;
      //echo $query;
      $usr=new User($a,$b,$c,$d,$e,$f,$g);
      $x=  serialize($usr);
               $_SESSION["User"]=$x;
